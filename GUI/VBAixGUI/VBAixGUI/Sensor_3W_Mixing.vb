...
#Region "Subs"
    Private Sub IconChange()
        ...
        If Rotation = Rotation.vertical Then
            Me.PictureBoxIcon.Image = Global.VBAixGUI.My.Resources.sensor_3w_valve_ver
        Else
            Me.PictureBoxIcon.Image = Global.VBAixGUI.My.Resources.sensor_3w_valve_hor
        End If
    End Sub
#End Region
