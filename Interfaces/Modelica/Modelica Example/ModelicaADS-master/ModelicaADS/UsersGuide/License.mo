within ModelicaADS.UsersGuide;
class License "Modelica License 2"
  extends Modelica.Icons.Information;
  annotation(Documentation(info="<html>
 <h4>Other Software</h4>
<p>The TwinCAT software is supplied and property of Beckhoff (c). Windows 7 and Visual
Studio are supplied and property of Microsoft (c). The header file AdsHeaderFile.h was developed
by Fraunhofer IBP but contains functions algorithms provided by Beckhoff.</p>
